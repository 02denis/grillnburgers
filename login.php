...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      echo '<script>alert("Parola sau email gresit!"); window.location = "login.php";</script>';
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="submit" value="Logare" name="submit" class="btn">
      <p>Nu ai un cont?<br><a href="register.php">Inregistreaza-te acum!</a></p>
   </form>
