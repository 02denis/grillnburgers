...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p class="grand-total"><span class="name" style="color:black">Total de plata:</span><span class="price">$<?= $grand_total-1; ?></span></p>
   ...
   <div class="user-info">
      ...
      <br><a href="update_profile.php" class="btn">modifica</a><br><br><br>
      <input type="datetime-local" id="meeting-time" name="meeting-time"
       value="2023-01-01T19:30" min="2023-01-01T19:30" max="2099-12-12T19:30"
       style="color: black">
       <br>
